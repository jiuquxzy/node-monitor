...
export default defineComponent({
  ...
  methods: {
    getMeta() {
      return axios.get('http://localhost:8088/miners').then((res) => {
          ...
          this.containerList = data.map((item) => {
            return {
              ...
              data: {
                ...
                'ValidatedSpace': item.miner_metadata.validated_space,
                'UsedSpace': item.miner_metadata.used_space,
                'LockedSpace': item.miner_metadata.locked_space,
                ...
                'MemoryUsage': item.container_status.mem_usage,
              },
            }
          })
        }
